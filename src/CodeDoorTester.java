...
public class CodeDoorTester {
    ...
    public void run() {
        ...
        pointLevels.add(Arrays.asList(7, 102));
        pointLevels.add(Arrays.asList(9, 100));
        pointLevels.add(Arrays.asList(11, 98));
        pointLevels.add(Arrays.asList(15, 94));
        ...
        String teamMembers = this.finder.getAuthors();
        ...
        System.out.println();
        System.out.println("Reminder: this score is only \"official\" if Kyle ran it.  Your actual grade may be very different!  In order to get your official grade, please follow the submission instructions.");
    }
